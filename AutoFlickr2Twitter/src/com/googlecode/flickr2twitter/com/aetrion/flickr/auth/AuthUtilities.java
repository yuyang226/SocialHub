...
import com.googlecode.flickr2twitter.com.aetrion.flickr.ParameterAlphaComparator;
import com.googlecode.flickr2twitter.com.aetrion.flickr.RequestContext;
import com.googlecode.flickr2twitter.com.aetrion.flickr.util.ByteUtilities;
...
public class AuthUtilities {
    ...
    public static String getMultipartSignature(String sharedSecret, List<Parameter> params) {
     ...
     * @param params
     */
    public static void addAuthToken(List<Parameter> params) {
     ...
     */
    public static boolean isAuthenticated(List<Parameter> params) {
        Iterator<Parameter> it = params.iterator();
        boolean tokenFlag = false;
        while (it.hasNext()) {
            if (((Parameter) it.next()).getName().equals("auth_token")) {
